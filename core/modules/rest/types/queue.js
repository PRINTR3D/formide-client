...
module.exports = function(routes, db) {
	...
	routes.get('/queue', FormideOS.manager('core.http').server.permissions.check('rest'), function(req, res) {
	...
	routes.get('/queue/:id', FormideOS.manager('core.http').server.permissions.check('rest'), function(req, res) {
	...
	routes.post('/queue/:printjobID', FormideOS.manager('core.http').server.permissions.check('rest'), function(req, res) {
	...
	routes.delete('/queue/:id', FormideOS.manager('core.http').server.permissions.check('rest'), function(req, res) {
