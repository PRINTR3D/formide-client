...
module.exports = function(routes, db)
{
	 ...
	 */
	routes.get('/modelfiles', FormideOS.manager('http').server.permissions.check('db'), function(req, res) {
	 ...
	 */
	routes.get('/modelfiles/:id', FormideOS.manager('http').server.permissions.check('db'), function(req, res) {
	 ...
	 */
	routes.delete('/modelfiles/:id', FormideOS.manager('http').server.permissions.check('db'), function(req, res) {
