...
module.exports = function(grunt) {
	...
	grunt.initConfig({
		...
		clean: {
			...
			stylesheets: ["./public/assets/sass/*"]
		},
		cleanempty: {
			options: {},
		...
		curl: {
			'unity': {
			    ...
			    dest: 'app/assets/unity/UnityObject2.js'
			}
		},
		copy: {
			main: {
				files: [
					...
					{
						expand: true,
						cwd: './app/assets/unity/',
						src: ['**/*.unity3d'],
						dest: './public/assets/unity/',
						filter: 'isFile'
					}
				]
			}
		...
		concat: {
			...
			js_main: {
				src: [
					...
					'./app/assets/javascripts/dependencies/raphael.2.1.0.min.js',
					'./app/assets/javascripts/dependencies/justgage.1.0.1.min.js'
				],
			...
			js_angular: {
				src: [
					...
					'./app/assets/components/hammerjs/hammer.js',
					'./app/assets/components/ngModal/dist/ng-modal.js',
					'./app/assets/components/angular-socket-io/socket.min.js',
					'./app/assets/components/angular-growl-notifications/dist/angular-growl-notifications.js',
			...
			js_unity: {
				src: [
					'./app/assets/unity/UnityObject2.js',
					'./app/assets/unity/printrViewerInterface.js'
				],
				dest: './public/assets/javascripts/unity.js'
			},
			css_octicons: {
				src: [
		...
		watch: {
			...
			templates: {
				files: './app/assets/javascripts/partials/**/*.html',
				tasks: [
					'copy'
				]
			}
